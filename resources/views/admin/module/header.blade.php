	...
	<div id="header" class="not-sticky">
		<div class="container">
			...
			<div class="left-side">
				...
				<!-- Logo -->
				<div id="logo">
					<a href="{{route('admin.home')}}"><img src="{{asset('assets/images/logo.png')}}" alt=""></a>
					<a href="{{route('admin.home')}}" class="dashboard-logo"><img src="{{asset('assets/images/logo2.png')}}" alt=""></a>
				</div>
			...
			<div class="right-side">
				...
				<div class="header-widget">
					...
					<!-- User Menu -->
					<div class="user-menu">
						<div class="user-name"><span><img src="{{asset("assets/images/dashboard-avatar.jpg")}}" alt=""></span>{{ Auth::user()->name }}</div>
						<ul>
